...
public class CUtil {
     ...
     * @return
     */
    public static String getAuthname(String code) {
        try {
            Properties properties = PropertiesLoaderUtils.loadProperties(new ClassPathResource("application.properties"));
            if (properties.containsKey(code)) {
                return properties.getProperty(code);
            } else {
                throw new CException("不存在此属性");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static String autocodeEncode(String source, int expiry) {
//        return authcode(source, EbhConfig.authkey, AuthcodeMode.Encode, expiry);
        return authcode(source, getAuthname("authkey"), AuthcodeMode.Encode, expiry);
    }
...
//        return authcode(source, EbhConfig.authkey, AuthcodeMode.Decode, 0);
        return authcode(source, getAuthname("authkey"), AuthcodeMode.Decode, 0);
    }
    ...
    private static String authcode(String source, String key,
                                   AuthcodeMode operation, int expiry) {
        try {
            ...
            keyc = ckey_length > 0 ? (operation == AuthcodeMode.Decode ? CutString(
    ...
    public static void main(String[] args) {
        System.out.println(CUtil.MD5("abc"));
        System.out.println(CUtil.RandomString(10));
